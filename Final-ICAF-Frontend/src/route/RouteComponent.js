...
import AdminPage from '../pages/AdminPage/AdminPage'; //admin dashboard
...
import RegAdmin from '../pages/RegAdmin/RegAdmin'; //registering admin
import AdminLoginPage from '../pages/AdminLoginPage/AdminLoginPage'; //admin login page
